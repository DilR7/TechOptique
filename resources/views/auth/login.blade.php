    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-blue-50 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <h1 class="text-3xl font-semibold mb-6 text-blue-900 text-center">Welcome Back!</h1>
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email"
                            class="mt-1 p-2 w-full border rounded-md focus:border-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-300 transition-colors duration-300"
                    ...
                    <div class="mt-4 flex justify-between">
                        <label for="remember_me" class="flex items-center">
                            <input id="remember_me" type="checkbox"
                                class="rounded border-blue-700 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                name="remember">
                    ...
                    <div>
                        <button type="submit"
                            class="w-full bg-blue-800 text-white p-2 rounded-md hover:bg-blue-950 focus:outline-none focus:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-900 transition-colors duration-300">{{ __('Log in') }}</button>
                    </div>
                </form>
                <div class="mt-4 text-sm text-sky-600 text-center">
                    <p>Don't have an account? <a href="{{ route('register') }}"
                            class="text-blue-950 hover:underline">Register here</a>
                    </p>
                </div>
            </div>
        </div>
