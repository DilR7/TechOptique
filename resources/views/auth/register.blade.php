        ...
        <div class="w-full bg-blue-50 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    @csrf
                    <div>
                        <x-input-label for="name" class="block text-sm font-medium text-blue-700"
                            :value="__('Name')" />
                        <input type="text" id="name" name="name"
                            class="mt-1 p-2 w-full border rounded-md focus:border-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                            :value="old('name')" required autocomplete="name" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="email" class="block text-sm font-medium text-blue-700"
                            :value="__('Email')" />
                    ...
                    <div>
                        <x-input-label for="password" class="block text-sm font-medium text-blue-700"
                            :value="__('Password')" />
                    ...
                    <div>
                        <x-input-label for="password_confirmation" class="block text-sm font-medium text-blue-700"
                    ...
                    <div>
                        <button type="submit"
                            class="mt-3 w-full bg-blue-800 text-white p-2 rounded-md hover:bg-blue-950 focus:outline-none focus:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-900 transition-colors duration-300">{{ __('Register') }}</button>
                    </div>
                </form>
                <div class="mt-4 text-sm text-sky-600 text-center">
                    <p>Already have an account? <a href="{{ route('login') }}"
                            class="text-blue-950 hover:underline">Login Here</a>
                    </p>
                </div>
            </div>
        </div>
