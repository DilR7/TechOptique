        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        <x-input-label for="name" class="block text-sm font-medium text-gray-700"
                            :value="__('Name')" />
                    ...
                    <div>
                        <x-input-label for="email" class="block text-sm font-medium text-gray-700"
                            :value="__('Email')" />
                    ...
                    <div>
                        <x-input-label for="password" class="block text-sm font-medium text-gray-700"
                            :value="__('Password')" />
                    ...
                    <div>
                        <x-input-label for="password_confirmation" class="block text-sm font-medium text-gray-700"
                    ...
                    <div>
                        <button type="submit"
                            class="mt-3 w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">{{ __('Register') }}</button>
                    </div>
                </form>
